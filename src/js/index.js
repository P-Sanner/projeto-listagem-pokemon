/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem para o sol
    ...
    - obeservações 
        - usar 'console.log(...)' para verificação
*/
